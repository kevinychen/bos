...
int sys_net_transmit(void *va, uint32_t len);
int sys_net_receive(void *va);
int sys_mac_addr_low();
int sys_mac_addr_high();
...
ssize_t history(int fd, time_t *buf, size_t nbytes, off_t offset);
